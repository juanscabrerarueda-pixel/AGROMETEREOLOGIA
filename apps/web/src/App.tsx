    ...
    return (
      <main className="wrap">
        <section className="card">
          <h1>Panel agrometeorolÃÂ³gico</h1>
    ...
    <main className="wrap">
        ...
        <div className="hero-brand">
          ...
          <div>
            ...
            <p className="muted">
              ...
              lÃÂ­nea de tendencia para resumir comportamientos. El mapa horario te ayuda a encontrar
        ...
        {!helpHidden && (
          <div className="fold-body">
            <ol className="help-steps">
              <li>
                Comienza en <strong>Monitoreo en vivo</strong>: valida el sello ÃÂ¿Hace X min? y usa la actualizaciÃÂ³n automÃÂ¡tica (1, 5 o 15 min) para seguir tormentas en tiempo real.
              </li>
              <li>
              ...
              <li>
                Ajusta el rango rÃÂ¡pido (3 meses, 1 aÃÂ±o, 5 aÃÂ±os o 14 dÃÂ­as de pronÃÂ³stico). TambiÃÂ©n puedes fijar fechas manualmente cuando necesites comparar ventanas especÃÂ­ficas.
              </li>
              <li>
                Alterna entre acumulado diario o intensidad mÃÂ¡xima, activa MA/EMA para suavizar la serie histÃÂ³rica y combina los insights automÃÂ¡ticos para traducir la seÃÂ±al en acciones.
              </li>
              <li>
                Usa la distribuciÃÂ³n diaria y horaria para detectar ventanas secas o picos concentrados antes de programar labores a campo.
              </li>
            </ol>
          </div>
        )}
      ...
      <section className="card mobile-overview mb4">
        <div className="overview-top">
          <div className="overview-cell">
            <span className="tiny">UbicaciÃÂ³n activa</span>
            <strong>{overviewSummary.location}</strong>
            <p className="muted tiny">{rangeSummary}</p>
          </div>
          <div className="overview-cell">
            <span className="tiny">ÃÂltimo dato</span>
      ...
      <section className={`card controls mb4 ${filtersOpen ? 'open' : 'collapsed'}`}>
        <div className="controls-header">
          <div>
            <h2>Filtros rÃÂ¡pidos</h2>
            <p className="muted tiny">
              Define ubicaciÃÂ³n, rango y mÃÂ©tricas para ajustar la lectura histÃÂ³rica y el pronÃÂ³stico.
            </p>
          </div>
        ...
        <div className="controls-body">
          ...
          <div className="row gap mt2">
            <button
              ...
              title={isFutureRange ? 'La tendencia no aplica a pronÃÂ³sticos futuros' : ''}
            >
          ...
          <div className="refresh-controls mt2">
            <span className="tiny">ActualizaciÃÂ³n automÃÂ¡tica</span>
            <div className="seg compact">
      ...
      <section className={`card chart-card mb4 mobile-fold ${chartOpen ? 'open' : 'collapsed'}`}>
        <div className="fold-toggle-row">
          <div>
            <h2>Serie diaria</h2>
            <p className="muted tiny">
              {rangeSummary} - {metric === 'intensity' ? 'Intensidad mÃÂ¡xima por dÃÂ­a' : 'Acumulado diario (mm)'}
            </p>
          </div>
          ...
          <div className="fold-body">
            ...
            {series.error && (
              <div className="error-banner mb3">
                ...
                <p>{series.error.message || 'No pudimos contactar la API. Revisa tu conexiÃÂ³n o intenta nuevamente.'}</p>
              </div>
            )}
            ...
            {metaSummary && (
              <div className="meta-panel">
                <div className="meta-item">
                  <strong>ÃÂltima actualizaciÃÂ³n</strong>
                  <span>{metaSummary.updated}</span>
                </div>
                <div className="meta-item">
                  <strong>UbicaciÃÂ³n</strong>
            ...
            <div className="mt3">
              ...
              <details className="glossary">
                <summary>CÃÂ³mo leer la intensidad</summary>
                <ul>
            ...
            {(chartNarrative || quickImpact) && (
              <div className="narrative-card">
                {quickImpact && (
                  <p>
                    <strong>Lectura rÃÂ¡pida:</strong> {quickImpact}
                  </p>
                )}
      ...
      <section className={`card mb4 mobile-fold ${agroOpen ? 'open' : 'collapsed'}`}>
        <div className="fold-toggle-row">
          <div>
            <h2>Condiciones agroenergÃÂ©ticas</h2>
            <p className="muted tiny">
              Temperatura y humedad del suelo, ET0, radiaciÃÂ³n y viento para apoyar ganaderos,
              agricultores y generaciÃÂ³n renovable.
            </p>
          </div>
        ...
        {(agroOpen || !isMobile) && (
          <div className="fold-body">
            ...
            <details className="glossary mt2">
              <summary>CÃÂ³mo leer estas variables</summary>
              <ul>
                <li>Temp. ambiente 18-32 C: confortable. &lt;15 C implica amaneceres frÃÂ­os y &gt;32 C demanda sombra e hidrataciÃÂ³n.</li>
                <li>SensaciÃÂ³n tÃÂ©rmica &gt;35 C: riesgo de estrÃÂ©s para personal y ganado.</li>
                <li>Humedad relativa &lt;40 %: ambiente seco, incrementa demanda hÃÂ­drica; &gt;85 % favorece hongos.</li>
                <li>Lluvia 24h: &lt;5 mm se absorbe rapido; &gt;30 mm provoca charcos y compactacion.</li>
                <li>ET0 &gt;4 mm indica alta demanda de riego. RadiaciÃÂ³n &gt;4 kWh/m2 favorece la generaciÃÂ³n solar.</li>
              </ul>
            </details>
          </div>
        )}
      ...
      <section className={`card mb4 mobile-fold ${hourlyOpen ? 'open' : 'collapsed'}`}>
        ...
        {(hourlyOpen || !isMobile) && (
          <div className="fold-body">
            ...
            <details className="glossary mt2">
              <summary>CÃÂ³mo leer la distribuciÃÂ³n</summary>
              <ul>
                <li>Bandas intensas al amanecer indican suelos saturados: retrasa la entrada de maquinaria.</li>
                <li>Bloques continuos &gt;60 % seÃÂ±alan varios dÃÂ­as lluviosos. Busca ventanas pÃÂ¡lidas (&lt;30 %) para labores crÃÂ­ticas.</li>
      ...
      <section className={`card insights mobile-fold ${insightsOpen ? 'open' : 'collapsed'}`}>
        <div className="fold-toggle-row">
          <div>
            ...
            <p className="muted tiny">
              Basados en umbrales de impacto y cÃÂ¡lculos del paquete insight-engine.
            </p>
          </div>
          ...
          <div className="fold-body">
            {insightSummary.count > 0 && (
              <div className="insights-kpis tiny">
                ...
                <span className="insights-chip">
                  <span className="chip-label">DÃÂ­as con dato</span>
            ...
            {sectorNarratives && (
              <div className="sector-insights">
                ...
                <div>
                  <strong>GanaderÃÂ­a</strong>
                  <p>{sectorNarratives.livestock}</p>
                </div>
                <div>
                  <strong>EnergÃÂ­as renovables</strong>
            ...
            {insights.error ? (
              <div className="error-banner">
                ...
                <p>{insights.error.message || 'No logramos conectar con la API de insights. Vuelve a intentarlo cuando tengas conexiÃÂ³n estable.'}</p>
              </div>
            ) : insights.data ? (
              insights.data.insights.length ? (
                ...
                <div className="empty-state">Sin hallazgos relevantes con los umbrales actuales. AjÃÂºstalos para mÃÂ¡s sensibilidad.</div>
              )
            ) : (
...
function buildImpactNarrative(summary: ChartSummary, metric: Metric, tense: Tense): string | null {
  ...
  return `${lead} ${formatNumber(summary.totalRain)} mm en ${summary.count.toLocaleString(
    'es-CO'
  )} dÃÂ­as. El pico diario ${peakVerb} ${formatNumber(summary.maxValue)} ${unit} (${badge.label}). ${impact}`;
}
...
function buildSectorNarratives(
  ...
  agricultureParts.push(
    `${isFuture ? 'Se proyectan' : 'Se analizaron'} ${summary.count.toLocaleString(
      'es-CO'
    )} dÃÂ­as con ${formatNumber(summary.totalRain)} mm (${formatNumber(summary.average)} mm/dÃÂ­a).`
  );
  if (badge?.label === 'Evento fuerte') {
    agricultureParts.push(
      `${isFuture ? 'La lluvia mÃÂ¡s intensa proyectada sugiere' : 'La lluvia mÃÂ¡s intensa sugiriÃÂ³'} atrasar siembra, fertilizaciÃÂ³n foliar y entrada de maquinaria hasta que el lote drene.`
  );
    ...
    agricultureParts.push(
      `${isFuture ? 'Humedad regular proyectada' : 'Humedad regular observada'}: vigila malezas y usa las ventanas con menos de 10 mm para cosecha mecÃÂ¡nica.`
    );
  }
  ...
  if (badge && (badge.label === 'Temporal' || badge.label === 'Evento fuerte')) {
    livestockParts.push(
      `${isFuture ? 'Pasturas en zonas bajas podrÃÂ­an encharcarse' : 'Pasturas en zonas bajas se encharcaron'}; rota hatos a potreros altos y refuerza caminos.`
    );
  } else if (summary.average < 4) {
    livestockParts.push(
      `${isFuture ? 'Secuencia mÃÂ¡s seca proyectada' : 'Secuencia mÃÂ¡s seca observada'}; provee sombra, sales y agua fresca para evitar estrÃÂ©s tÃÂ©rmico.`
    );
  } else {
    livestockParts.push(
      `${isFuture ? 'Humedad media favorecerÃÂ­a el rebrote' : 'Humedad media favoreciÃÂ³ el rebrote'}, pero revisa corrales en jornadas superiores a 20 mm.`
    );
  }
    ...
    if (temp >= 32 || (feels ?? temp) >= 35) {
      notes.push(
        `${isFuture ? 'Se proyecta' : 'Se observo'} calor alto (${temp.toFixed(1)} C) con sensacion ${(feels ?? temp).toFixed(
          1
        )} C; prioriza sombra, hidrataciÃÂ³n y labores cortas.`
      );
    } else if (temp <= 16) {
    ...
    if (rain >= 40) {
      notes.push(
        `${isFuture ? 'Lluvia abundante proyectada' : 'Lluvia abundante observada'} (${rain.toFixed(
          1
        )} mm/24 h) ${isFuture ? 'saturarÃÂ­a' : 'saturÃÂ³'} suelos; espera drenaje antes de entrar maquinaria.`
      );
    } else if (rain >= 12) {
  ...
  if (metric === 'accumulated') {
    parts.push(
      `Entre ${rangeLabel} ${isFuture ? 'se proyectan' : 'se acumularon'} ${formatNumber(
        summary.totalRain
      )} mm${isFuture ? ' proyectados' : ''} distribuidos en ${summary.count} dÃÂ­as con datos.`
    );
    if (summary.maxValueDate) {
      parts.push(
        `El dÃÂ­a mÃÂ¡s lluvioso ${isFuture ? 'proyectado serÃÂ­a' : 'fue'} ${formatDisplayDate(
    ...
    parts.push(
      `${isFuture ? 'Se proyectan' : 'Se analizaron'} ${summary.count} dÃÂ­as de intensidades entre ${rangeLabel}.`
    );
    if (summary.maxValueDate) {
      parts.push(
        `La rÃÂ¡faga mÃÂ¡xima ${isFuture ? 'proyectada ocurrirÃÂ­a' : 'ocurriÃÂ³'} el ${formatDisplayDate(
          summary.maxValueDate
        )} y ${isFuture ? 'alcanzarÃÂ­a' : 'alcanzÃÂ³'} ${formatNumber(summary.maxValue)} mm/h.`
      );
    }
  }
